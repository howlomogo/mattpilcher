          ...
          <div className='container'>
            <div className='row'>
              <div className='col-md-12'>
                <div className='animated fadeIn'><img src={BannerPhoto} alt='Banner Photo' className='mb-4' />
                ...
                </div><a className='animated fadeIn' href='/portfolio.html'>
                  <button className='btn inverted'>VIEW MY WORK</button></a>
              </div>
            </div>
          </div>
        </section>
          ...
          <div className='container'>
            <div className='row'>
              <div className='col-md-12'>
                ...
                <p className='wow fadeIn' data-wow-duration='1s'>I have been programming for over 10 years and have 5 years commercial experience working within the web industry along side digital agencies and software companies. I am very passionate about web development and enjoy creating cleanly written, responsive websites.</p>
                <p className='wow fadeIn' data-wow-duration='1s'>I also have an interest in game development and have released 2 games onto the app store. I am always open to new opportunities including freelance work so please feel free to contact me if you are in need of a front end developer.</p>
              </div>
            </div>
          </div>
        </section>
          ...
          <div className='container'>
            <div className='row text-center'>
              <div className='col-md-12'>
                ...
                <p className='mb-5 wow fadeIn' data-wow-duration='1s'>My main skills are listed below, I use Javascript, HTML &amp; Sass / CSS on a daily basis. The framework will depend on my current project, While programming I like to follow best practises and keep code as clean as possible.</p>
              </div>
            </div>
            <div className='row'>
              <div className='col-md-8'>
                <div className='wow fadeIn' data-wow-duration='1s'>
                  <h3 className='mb-2 color--primary'>MAIN SKILLS &amp; TOOLS</h3>
                  <hr className='hr-dashed--light-full mb-5'/>
                </div>
              </div>
              <div className='col-md-4 mobile--hide'>
                <div className='wow fadeIn' data-wow-duration='1s'>
                  <h3 className='mb-2 color--primary'>OTHER SKILLS</h3>
                  <hr className='hr-dashed--light-full mb-5'/>
                </div>
              </div>
            </div>
